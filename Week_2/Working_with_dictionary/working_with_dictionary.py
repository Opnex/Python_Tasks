...
# Keys: Keys are unique and used to store and retrieve values
# Value: Value can be any data type (string, integer, list, tuple, even another dictionary).
...
student_info = dict(name="John", age=25, course="Math")
print(student_info)
...
# Using String Keys
names = ["Ada", "John", "Musa", "James"]
lengths = {name: len(names) for name in names}
print(lengths)
